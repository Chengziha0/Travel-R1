...
export DATA_DIR='/mnt/data/liuzeming_teacher/czh/Travel-R1/data/TravelPlanner'

export WAND_PROJECT="Travel-R1"
...
export EXPERIMENT_NAME="travel-planner-r1-grpo-qwen2.5-0.5b-it"
